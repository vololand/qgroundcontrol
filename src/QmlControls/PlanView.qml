...
// =============================================================================
// PlanView: 미션/지오펜스/랠리포인트/UTMSP 편집 화면의 루트
// - 지도 위에서 웨이포인트·패턴·펜스·랠리포인트를 편집하고, 파일/차량과 동기화
// =============================================================================
Item {
    id: _root
    ...
    // 지도 뷰포트를 미션/펜스/랠리 항목에 맞춰 자동 조정 (fit to items)
    MapFitFunctions {
    ...
    // 기본 미션 항목 고도 설정 변경 시, 기존 미션에 적용할지 묻는 반응
    Connections {
    ...
    // 미션·지오펜스·랠리포인트 편집의 총괄 컨트롤러 (파일/차량 로드·저장·업로드·다운로드)
    ...
    // 차량에서 새 미션 항목 로드 시 뷰포트 맞춤 + 현재 항목 초기화
    Connections {
    ...
    Item {
        ...
        // 편집용 지도: 줌/중심 저장, 클릭 시 웨이포인트/랠리/ROI 추가, 미션·펜스·랠리·UTMSP 시각화
        FlightMap {
            id:                         editorMap
            anchors.fill:               parent
            ...
            // 미션 항목(웨이포인트·이륙·착지·패턴 등)을 지도 위에 마커로 표시
            Repeater {
            ...
            // 현재 세그먼트 중간에 웨이포인트를 끼워 넣는 분할 UI (클릭 시 삽입)
            MapQuickItem {
                id:             splitSegmentItem
        ...
        // 좌측 툴스트립: File·이륙·웨이포인트·ROI·패턴·착지·중심 버튼 (드롭 패널로 세부 동작)
        ToolStrip {
            id:                 toolStrip
        ...
        // 우측 편집 패널 배경 (탭·미션/펜스/랠리/UTMSP 편집기가 이 위에 올라감)
        Rectangle {
            id:                 rightPanel
        ...
        // 우측 패널 내용: 레이어 탭 + 미션/펜스/랠리/UTMSP 편집기
        Item {
            ...
            Column {
                ...
                anchors.right:      parent.right
                anchors.top:        parent.top
                // Mission / Fence / Rally 레이어 전환 탭 (UTMSP 비활성 시)
                QGCTabBar {
                    id:         layerTabBar
                    width:      parent.width
                ...
                // Mission / Rally / UTM-Adapter 레이어 전환 탭 (UTMSP 활성 시)
                QGCTabBar {
                    id:         layerTabBarUTMSP
                    width:      parent.width
                    visible:    QGroundControl.corePlugin.options.enablePlanViewSelector && _utmspEnabled
            ...
            // UTMSP(비행 계획 제출) 편집기 (UTM-Adapter 탭 선택 시)
            UTMSPAdapterEditor{
                id: utmspEditor
                enabled:                 _utmspEnabled
                anchors.top:             rightControls.bottom
        ...
        // 지형 고도 데이터 제공자 라이선스 문구 (지형 상태 바로 위)
        QGCLabel {
    ...
    // 툴스트립 "Center" 버튼 드롭 패널: 지도 중심을 차량/홈/위치로 맞춤
    Component {
    ...
    // 툴스트립 "Pattern" 버튼 드롭 패널: 복합 패턴(사각·원 등) 선택 후 지도에 추가
    Component {
        id: patternDropPanel
    ...
    // 툴스트립 "File" 버튼 드롭 패널: 플랜 생성·열기·저장·KML·업로드·다운로드·지우기
    Component {
        id: syncDropPanel
